...
That's it — no separate proxy, no backend process. The Next.js app handles everything, including CORS-bypass API routes.
...
- More DISCOMs beyond UPPCL — the architecture is already factored; add a new client module and wire it behind configuration.
...
Open an issue with:
- What you did (click sequence or API call)
- What you expected
- What actually happened (browser console errors, network tab screenshots)
- Your environment (OS, Node/Bun version, browser, dashboard route)
